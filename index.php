...
<div align="center"> <!-- begin center -->
	...
	<div class="left_page"> <!-- begin left -->
		<form method="POST"> <!-- begin registration form -->
	    	<table cellpadding="2" cellspacing="0"> <!-- begin registration table -->
	        	<tr>
	        ...
	        </table> <!-- end registration table -->
	    </form> <!-- end registration form -->
    </div> <!-- end left -->
	<div class="right_page"> <!-- begin right -->
		<form method="POST"> <!-- begin login form -->
			<table cellpadding="2" cellspacing="0"> <!-- begin login table -->
				<tr>
